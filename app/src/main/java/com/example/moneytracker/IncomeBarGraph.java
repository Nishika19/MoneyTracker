...
public class IncomeBarGraph extends AppCompatActivity {

      BarChart barChart;
     BarData barData;
     private Button expense_bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_income_bar_graph);
         ...
         expense_bar = findViewById(R.id.expense_pie_chart);
        pie_chart_btn = findViewById(R.id.pie_chart_btn);

        expense_bar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(IncomeBarGraph.this,BarGraphActivity.class));
                finish();
            }
        });
        pie_chart_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(IncomeBarGraph.this,GraphActivity.class));
                finish();
            }
        });
