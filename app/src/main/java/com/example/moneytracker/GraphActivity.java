...
public class GraphActivity extends AppCompatActivity {
    ...
    PieChart pieChart;
    PieData pieData;
    private Button income_pie_chart;
         ...
         AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_NO);
          ...
          barGraph.setOnClickListener(new View.OnClickListener() {
              ...
              public void onClick(View v) {
                  startActivity(new Intent(GraphActivity.this,BarGraphActivity.class));
                 // finish();
              }
          });
          income_pie_chart.setOnClickListener(new View.OnClickListener() {
              @Override
              public void onClick(View v) {
                  startActivity(new Intent(GraphActivity.this,Income_pie_chart.class));
                  //finish();
              }
          });
    ...
    private void pieChartEntry(List<Transaction> incomeList) {
        for(int i=0;i<incomeList.size();i++){
         ...
         PieDataSet pieDataSet = new PieDataSet(pieEntryList,"Categorical Expense Distribution");
